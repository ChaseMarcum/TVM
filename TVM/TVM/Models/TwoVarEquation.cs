...
namespace TVM.Models
{
    public class TwoVarEquation
    {
        ...
        public string[] description = {"The Average Tax Rate is the total taxes paid divided by total taxable income.",
                                        ...
                                        "To calculate the Cash flow to Creditors take the Interest paid minus the Net New Borrowing",
                                        "To calculate the Cash flow to Stockholders take the Dividends paid minus the Net New Equity",
